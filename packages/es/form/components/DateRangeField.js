...
export default function DateRangeField(_ref) {
  ...
  var isHasHour = (props === null || props === void 0 ? void 0 : (_props$format = props.format) === null || _props$format === void 0 ? void 0 : _props$format.indexOf('H')) >= 0 || (props === null || props === void 0 ? void 0 : (_props$format2 = props.format) === null || _props$format2 === void 0 ? void 0 : _props$format2.indexOf('h')) >= 0;
  ...
  var value = [];
  if (isArray(val)) val === null || val === void 0 ? void 0 : val.forEach(function (item) {
    value.push(item);
  });
  useEffect(function () {
    if (!bind || (bind === null || bind === void 0 ? void 0 : bind.length) < 2) {
      console.error("Warning: schema ".concat(label, "\u7EC4\u4EF6 bind \u503C\u6709\u8BEF"));
    }
  }, []);
  ...
  useUpdateLayoutEffect(function () {
    // 时间处理
    var start = fieldData[bind[0]] ? !isHasHour ? "".concat(fieldData[bind[0]], " 00:00:00") : fieldData[bind[0]] : undefined;
    var end = fieldData[bind[1]] ? !isHasHour ? "".concat(fieldData[bind[1]], " 23:59:59") : fieldData[bind[1]] : undefined;
  ...
  function changeHandle(date, dateStrings) {
    var _data;
    // 时间处理
    var start = dateStrings[0] ? !isHasHour ? "".concat(dateStrings[0], " 00:00:00") : dateStrings[0] : undefined;
    var end = dateStrings[1] ? !isHasHour ? "".concat(dateStrings[1], " 23:59:59") : dateStrings[1] : undefined;
    var dateFormats = [start ? dayjs(start) : '', end ? dayjs(end) : ''];
    setVal(dateFormats);
    var data = (_data = {}, _defineProperty(_data, (bind === null || bind === void 0 ? void 0 : bind[0]) || 'start', start), _defineProperty(_data, (bind === null || bind === void 0 ? void 0 : bind[1]) || 'end', end), _data);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "error-message"
  }, " ", validateResult === null || validateResult === void 0 ? void 0 : validateResult.message, " ") : null, /*#__PURE__*/React.createElement(RangePicker, _extends({
