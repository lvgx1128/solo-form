...
export default function InputFiled(_ref) {
  ...
  var updateFormData = useDebounce(function () {
    setData === null || setData === void 0
      ? void 0
      : setData(_defineProperty({}, fieldKey, val));
  }, 600);
  /**
   * input change事件
   */
            ...
            _extends(
              ...
              props,
              {
                onChange: function onChange(evt) {
                  ...
                  return changeHandle(
                    (_evt$target$value$tri =
                      evt === null || evt === void 0
                        ? void 0
                        : (_evt$target = evt.target) === null ||
                          _evt$target === void 0
                        ? void 0
                        : (_evt$target$value = _evt$target.value) === null ||
                          _evt$target$value === void 0
                        ? void 0
                        : _evt$target$value.trim()) !== null &&
                      _evt$target$value$tri !== void 0
                      ? _evt$target$value$tri
                      : '',
                  );
                },
