...
export default function RadioField(_ref) {
  ...
  function changeHandle(evt) {
    var _evt$target$value, _evt$target;
    var value = (_evt$target$value = evt === null || evt === void 0 ? void 0 : (_evt$target = evt.target) === null || _evt$target === void 0 ? void 0 : _evt$target.value) !== null && _evt$target$value !== void 0 ? _evt$target$value : '';
    setVal(value);
    setData === null || setData === void 0 ? void 0 : setData(_defineProperty({}, fieldKey, value));
  ...
  var formItem = classnames('solo-form-item', {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "error-message"
  }, " ", validateResult === null || validateResult === void 0 ? void 0 : validateResult.message, " ") : null, /*#__PURE__*/React.createElement(Group, _extends({
    value: val,
