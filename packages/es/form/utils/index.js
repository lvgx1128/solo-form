...
export function schemaFormat(schema, newValue) {
  ...
  properties =
    (_newSchema$properties =
      newSchema === null || newSchema === void 0
        ? void 0
        : newSchema.properties) !== null && _newSchema$properties !== void 0
      ? _newSchema$properties
      : {};
  ...
  keys.forEach(function (item) {
    ...
    var props = _objectSpread(
      _objectSpread(
        {},
        propItem === null || propItem === void 0 ? void 0 : propItem.props,
      ),
      newPropItem === null || newPropItem === void 0
        ? void 0
        : newPropItem.props,
    );
    properties[item] = _objectSpread(
      _objectSpread(_objectSpread({}, propItem), newPropItem),
      {},
      {
        props: props,
      },
    ...
    if (item === 'itemProps') {
      ...
      newSchema[item] = _objectSpread(
        _objectSpread({}, itemProps),
        newPropItem,
      );
    }
  });
